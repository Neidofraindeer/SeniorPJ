...
<body>
    ...
    <div>
        ...
        <ul><br>
        <li onclick="document.location='Of-setting.php'">แก้ไขข้อมูลส่วนตัว</li>
        <li onclick="document.location='Of-repassword.php'">เปลี่ยนรหัสผ่าน</li>
    ...
    <div class="content">
        ...
        <form method="GET" class="search-bar">
            ...
            <button type="button" class="btn-add" onclick="document.location='Of-inputcar.php'">เพิ่มรายการ</button>
        </form>
        <table>
            <thead>
                <tr>
                ...
                $result = $conn->query($sql);
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr onclick=\"window.location='Of-car-detail.php?id=" . $row['Work_ID'] . "'\" style='cursor: pointer;'>";
