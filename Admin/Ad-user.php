            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<tr  style='cursor: pointer;'>
                            ...
                            <td onclick=\"window.location='Ad-user-detail.php?id=" . $row['User_ID'] . "'\">" . $row['Username'] . "</td>
                            <td onclick=\"window.location='Ad-user-detail.php?id=" . $row['User_ID'] . "'\">" . $row['User_Firstname'] . "</td>
                            <td onclick=\"window.location='Ad-user-detail.php?id=" . $row['User_ID'] . "'\">" . $row['User_Lastname'] . "</td>
                            <td onclick=\"window.location='Ad-user-detail.php?id=" . $row['User_ID'] . "'\">" . $row['Department_Name'] . "</td>
                            <td class='actions'>
